...
class Run extends Action implements HttpPostActionInterface {
	...
	public function __construct(JsonFactory $jsonFactory, Context $context, HeaderDataFactory $headerDataFactory, Orchestrator $orchestrator) {
	...
	public function execute() {
		...
		$this->orchestrator->run(
			$this->getRequest()->getParam('order_id'), $headerData
		);
